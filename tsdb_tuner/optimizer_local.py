...
class LocalSearchOptimizer:
    """
    Практичная замена «чистого» градиентного спуска для параметров СУБД.
    Конфигурации дискретные и шумные, поэтому используется покоординатный поиск:
    меняем один параметр вверх/вниз, запускаем benchmark, оставляем улучшение.
    """
